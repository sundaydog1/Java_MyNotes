...
public class ArrayPractice {
    public static void main(String[] args) {
        ...
        arrayOfLists[0].set(4,50); // to change the 5th element in [1st array]


        Set<Integer>[]arrayOfSets = new Set[5];
        System.out.println(Arrays.toString(arrayOfSets));

        arrayOfSets[0] = new LinkedHashSet<>(Arrays.asList(1,2,3,4,5));
        ...
        arrayOfSets[2].addAll(Arrays.asList(10,20,30,40));
    }
}
